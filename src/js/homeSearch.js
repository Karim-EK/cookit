...
const searchPanel = document.getElementById("togglable");
 ...
 * <div class="flex items-center justify-between w-full">
        <div class="flex items-center gap-s">
            <img class="h-icon" src="/Cookit/src/assets/example1.webp" alt="">
            <p style="max-height:calc((1em + 0.5rem) + 3rem); overflow: hidden;">Tagliatelle Smerdose del cazzo dio porco la madonna in cariola bastarda</p>
        </div>
        <p>Intermedio</p>
    </div>
 */